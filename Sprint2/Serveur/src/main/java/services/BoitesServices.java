...
public class BoitesServices {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public ArrayList<Courrier> getListCourrier(@PathParam("idBoite") long idBoite){
    ...
    @Path("/{idBoite}/courrier")
    @Consumes(MediaType.APPLICATION_JSON)
    public String getReceptionCourrier(@PathParam("idBoite") long idBoite, Courrier courrier) {
    ...
    @Path("/{idBoite}/colis")
    @Produces(MediaType.APPLICATION_JSON)
    public ArrayList<Colis> getListColis(@PathParam("idBoite") long idBoite){
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    public String colisDepose(@PathParam("idBoite") long idBoite,@PathParam("idColis") long idColis, Colis colis) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    public String colisPrisFacteur(@PathParam("idBoite") long idBoite,@PathParam("idColis") long idColis, Colis colis) {
