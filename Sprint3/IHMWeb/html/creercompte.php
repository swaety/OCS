	...
	else
{
	...
	<div id="contenu">
		<div id="choice">
			...
			<button id="prticulier" onclick="particulier()">Particulier</button>
			<button id="poste" onclick="poste()">Poste</button>
		</div>
		
		<div id="particulier"  style="visibility:hidden;">
		...
		<div id="poste"  style="visibility:hidden;">
				<form method="post" action="creercompte.php" name="registerform" id="registerform">
					<fieldset>
				...
				<label for="activityRange">Rayon d'activité</label>
				<input type="text" id="activityRange" name="activityRange" placeholder="rayon d'activite en km">
